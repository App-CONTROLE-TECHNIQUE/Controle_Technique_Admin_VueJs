...
<script>
    ...
    import listHeader from './carteGriseHeaders';
    import addjson from './carteGriseFields'
    import constants from "../../../../plugins/constants";
    import model from './carteGriseModel.json'
    export default {
        name: "userList",
        data() {
            return{
                pagename:'Carte grise',
                show:true,
                title:'Carte grise',
                saveUrll: constants.resource_url+'admin/cartegrises',
                ...
                deleteUrl: constants.resource_url+'admin/cartegrises',
                name_graph: 'Carte grise',
                modell: model,
                dialogDelete:false,
                previousButton:true,
                editButton:true,
                ...
                deleteButton:true,
                headers:listHeader,
                list: constants.resource_url+'admin/cartegrises',
                list_kanban:[],
                percent_visit:[],
                list_hist:[],
                abcis:[],
        ...
        methods: {
            ...
            deleteItemConfirm (item){
                axios.delete(this.list+'/'+item.carteGriseId)
                    .then(org => {
