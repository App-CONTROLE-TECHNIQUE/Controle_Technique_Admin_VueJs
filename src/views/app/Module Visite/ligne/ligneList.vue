...
<script>
    ...
    import listHeader from './ligneHeaders';
    import addjson from './ligneField'
    import constants from "../../../../plugins/constants";
    import model from './ligneModel.json'
    export default {
        name: "userList",
        data() {
            return{
                ...
                show:true,
                title:'Ligne',
                saveUrll: constants.resource_url+'admin/lignes',
                ...
                deleteUrl: constants.resource_url+'admin/lignes',
                name_graph: 'Ligne',
                modell: model,
                dialogDelete:false,
                previousButton:true,
                ...
                deleteButton:true,
                headers:listHeader,
                list: constants.resource_url+'admin/lignes',
                list_kanban:[],
                percent_visit:[],
                list_hist:[],
                abcis:[],
        ...
        methods: {
            ...
            deleteItemConfirm (item){
                axios.delete(this.list+'/'+item.idLigne)
                    .then(org => {
