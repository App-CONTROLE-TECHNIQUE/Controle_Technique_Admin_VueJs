...
<script>
    ...
    import listHeader from './machineHeaders';
    import addjson from './machineField'
    import constants from "../../../../plugins/constants";
    import model from './machineModel.json'
    export default {
        name: "userList",
        data() {
            return{
                ...
                show:true,
                title:'Machine',
                saveUrll: constants.resource_url+'admin/machines',
                fillselectUrll: constants.resource_url+'admin/organisation/child/select',
                fillSecondSelectUrll: constants.resource_url+'admin/constructorModels/select',
                fillThirdSelectUrll: constants.resource_url+'admin/constructorModels/select',
                deleteUrl: constants.resource_url+'admin/machines',
                name_graph: 'Machine',
                modell: model,
                dialogDelete:false,
                previousButton:true,
                ...
                deleteButton:true,
                headers:listHeader,
                list: constants.resource_url+'admin/machines',
                list_kanban:[],
                percent_visit:[],
                list_hist:[],
                abcis:[],
        ...
        methods: {
            ...
            deleteItemConfirm (item){
                axios.delete(this.list+'/'+item.idMachine)
                    .then(org => {
