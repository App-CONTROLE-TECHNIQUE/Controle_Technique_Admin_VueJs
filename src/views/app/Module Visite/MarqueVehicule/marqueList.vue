...
<script>
    ...
    import listHeader from './marqueHeaders';
    import addjson from './marqueField'
    import constants from "../../../../plugins/constants";
    import model from './marqueModel.json'
    export default {
        name: "userList",
        data() {
            return{
                ...
                show:true,
                title:'Marque',
                saveUrll: constants.resource_url+'admin/marques',
                ...
                deleteUrl: constants.resource_url+'admin/marques',
                name_graph: 'Caissier',
                modell: model,
                dialogDelete:false,
                previousButton:true,
                ...
                deleteButton:true,
                headers:listHeader,
                list: constants.resource_url+'admin/marques',
                list_kanban:[],
                percent_visit:[],
                list_hist:[],
                abcis:[],
        ...
        methods: {
            ...
            deleteItemConfirm (item){
                axios.delete(this.list+'/'+item.marqueVehiculeId)
                    .then(org => {
