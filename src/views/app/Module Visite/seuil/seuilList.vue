...
<script>
    ...
    import listHeader from './seuilHeaders';
    import addjson from './seuilField'
    import constants from "../../../../plugins/constants";
    import model from './seuilModel.json'
    export default {
        name: "seuilList",
        data() {
            return{
                ...
                show:true,
                title:'Seuil',
                saveUrll: constants.resource_url+'admin/seuils',
                fillselectUrll: constants.resource_url+'admin/organisation/child/select',
                fillSecondSelectUrll: constants.resource_url+'admin/lexique/select',
                fillThirdSelectUrll: constants.resource_url+'admin/formules/select',
                deleteUrl: constants.resource_url+'admin/seuils',
                name_graph: 'Seuil',
                modell: model,
                dialogDelete:false,
                previousButton:true,
                ...
                deleteButton:true,
                headers:listHeader,
                list: constants.resource_url+'admin/seuils',
                list_kanban:[],
                percent_visit:[],
                list_hist:[],
                abcis:[],
