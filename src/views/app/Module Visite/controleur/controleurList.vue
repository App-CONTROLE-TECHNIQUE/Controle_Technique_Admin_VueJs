...
<script>
    ...
    import listHeader from './controleurHeaders';
    import addjson from './controleurFields'
    import constants from "../../../../plugins/constants";
    import model from './controleurModel.json'
    export default {
        name: "ControleurList",
        data() {
            return{
                ...
                show:true,
                title:'Contrôleur',
                saveUrll: constants.resource_url+'admin/controleurs',
                fillselectUrll: constants.resource_url+'admin/organisation/child/select',
                fillSecondSelectUrll: constants.resource_url+'users/system/select',
                deleteUrl: constants.resource_url+'admin/caissiers',
                name_graph: 'Caissier',
                modell: model,
                dialogDelete:false,
                previousButton:true,
                ...
                deleteButton:true,
                headers:listHeader,
                list: constants.resource_url+'admin/controleurs',
                list_kanban:[],
                percent_visit:[],
                list_hist:[],
                abcis:[],
        ...
        methods: {
            ...
            deleteItemConfirm (item){
                axios.delete(this.list+'/'+item.idControleur)
                    .then(org => {
