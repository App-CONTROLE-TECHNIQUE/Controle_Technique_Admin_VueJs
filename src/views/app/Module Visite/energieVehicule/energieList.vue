...
<script>
    ...
    import listHeader from './energieHeaders';
    import addjson from './energieField'
    import constants from "../../../../plugins/constants";
    import model from './energieModel.json'
    export default {
        name: "userList",
        data() {
            return{
                ...
                show:true,
                title:'Produit',
                saveUrll: constants.resource_url+'admin/energies',
                fillselectUrll: constants.resource_url+'admin/organisation/child/select',
                fillSecondSelectUrll: constants.resource_url+'admin/catproducts/forselect',
                fillThirdSelectUrll: constants.resource_url+'users/system/select',
                deleteUrl: constants.resource_url+'admin/energies',
                name_graph: 'Caissier',
                modell: model,
                dialogDelete:false,
                previousButton:true,
                ...
                deleteButton:true,
                headers:listHeader,
                list: constants.resource_url+'admin/energies',
                list_kanban:[],
                percent_visit:[],
                list_hist:[],
                abcis:[],
        ...
        methods: {
            ...
            deleteItemConfirm (item){
                axios.delete(this.list+'/'+item.energieId)
                    .then(org => {
