...
<script>
    ...
    import listHeader from './formuleHeaders';
    import addjson from './formuleField'
    import constants from "../../../../plugins/constants";
    import model from './formuleModel.json'
    export default {
        name: "userList",
        data() {
            return{
                ...
                show:true,
                title:'Formule',
                saveUrll: constants.resource_url+'admin/formules',
                ...
                deleteUrl: constants.resource_url+'admin/formules',
                name_graph: 'Formule',
                modell: model,
                dialogDelete:false,
                previousButton:true,
                ...
                deleteButton:true,
                headers:listHeader,
                list: constants.resource_url+'admin/formules',
                list_kanban:[],
                percent_visit:[],
                list_hist:[],
                abcis:[],
