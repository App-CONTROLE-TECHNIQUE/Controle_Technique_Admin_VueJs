...
<script>
    ...
    import listHeader from './constructorModelHeaders';
    import addjson from './constructorModelField'
    import constants from "../../../../plugins/constants";
    import model from './constModel.json'
    export default {
        name: "userList",
        data() {
            return{
                pagename:'Modèle constructeur',
                show:true,
                title:'Modèle constructeur',
                saveUrll: constants.resource_url+'admin/constructorModels',
                fillselectUrll: constants.resource_url+'admin/organisation/child/select',
                fillSecondSelectUrll: constants.resource_url+'admin/constructors/select',
                fillThirdSelectUrll: constants.resource_url+'admin/constructors/select',
                fillFourthSelectUrll: constants.resource_url+'admin/produits/select',
                deleteUrl: constants.resource_url+'admin/constructorModels',
                name_graph: 'Modèle constructeur',
                modell: model,
                dialogDelete:false,
                previousButton:true,
                editButton:true,
                ...
                deleteButton:true,
                headers:listHeader,
                list: constants.resource_url+'admin/constructorModels',
                list_kanban:[],
                percent_visit:[],
                list_hist:[],
                abcis:[],
