...
<script>
    ...
    import listHeader from './vehiculeHeaders';
    import addjson from './vehiculeField'
    import constants from "../../../../plugins/constants";
    import model from './vehiculeModel.json'
    export default {
        name: "userList",
        data() {
            return{
                ...
                show:true,
                title:'Produit',
                saveUrll: constants.resource_url+'admin/vehicules',
                fillselectUrll: constants.resource_url+'admin/organisation/child/select',
                fillSecondSelectUrll: constants.resource_url+'admin/marques/select',
                fillThirdSelectUrll: constants.resource_url+'admin/energies/select',
                deleteUrl: constants.resource_url+'admin/vehicules',
                name_graph: 'Caissier',
                modell: model,
                dialogDelete:false,
                previousButton:true,
                ...
                deleteButton:true,
                headers:listHeader,
                list: constants.resource_url+'admin/vehicules',
                list_kanban:[],
                percent_visit:[],
                list_hist:[],
                abcis:[],
        ...
        methods: {
            ...
            deleteItemConfirm (item){
                axios.delete(this.list+'/'+item.vehiculeId)
                    .then(org => {
