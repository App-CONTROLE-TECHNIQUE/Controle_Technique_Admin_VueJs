<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    ...
    <div class="main-content">
        ...
        <breadcumb :page="'Assurances'" :folder="'Options'" />
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getRequestParams(searchTitle, page, pageSize, id) {
            ...
            FetchVueKanban(){
                    axios.get(constants.resource_url+'assurances/kanban')
                        .then(list => {
            ...
            FetchVueGraph(){
                ...
                axios.get(constants.resource_url+'assurances/graphview')
                    .then(list => {
            ...
            initialize () {
                ...
                /*axios.get('http://192.168.2.2:8080/api/v1/admin/catproducts')
                    .then(products => {
                ...
                // axios.get(constants.resource_url + 'assurances?page='+this.page+'&size='+this.pageSize)

                axios.get(constants.resource_url + 'assurances',
                    {
                        params: params})
            ...
            openItem (item) {
               ...
               axios.get(constants.resource_urls+ 'search/cartegrise/assurance/imma/' + item.vehicule)
                   .then(cg=>{
            ...
            deleteItemConfirm ()
            {
                axios.delete(constants.resource_url +'assurances/'+this.model.id)
            ...
            save () {
                ...
                if (this.editedIndex > -1) {
                    const instance = axios.post(constants.resource_urls  + 'assurances',
                    {
                        editvalue
