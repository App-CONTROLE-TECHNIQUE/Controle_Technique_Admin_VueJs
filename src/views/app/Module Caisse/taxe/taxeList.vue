<template>
    <GlobalVue v-if="show" :dialogDelete="dialogDelete" :pagename="pagename" :previousButton="previousButton" :list="list" :headers="headers" :editButton="editButton"
               ...
               :addjson="addjson" :deleteUrl="deleteUrl" :model="modell" :title="title"
               :fillselectUrl="fillselectUrll"
               :saveUrl="saveUrll"
...
<script>
    ...
    import listHeader from './taxeHeader';
    import addjson from './taxeFields'
    import constants from "../../../../plugins/constants";
    import model from './taxeModel.json'
    export default {
        name: "clientList",
        data() {
            return{
                ...
                show:true,
                title:'Taxe',
                saveUrll: constants.resource_url+'admin/taxes',
                fillselectUrll: constants.resource_url+'admin/organisation/child/select',
                fillSecondSelectUrll: constants.resource_url+'admin/produits/select',
                deleteUrl: constants.resource_url+'admin/contacts',
                list: constants.resource_url+'admin/taxes',
                name_graph: 'Contact',
                modell: model,
                dialogDelete:false,
                previousButton:true,
        ...
        methods: {
            ...
            onee(){
                this.$router.push({name: this.addvue, params:{ addjson:this.addjson, model: model,
                        title: this.titlee,
            ...
            editItem (item) {
                this.$router.push({name: this.addvue, params:{ addjson:this.addjson, model: this.modell,
                        title: this.titlee,
                        fillselectUrl: this.fillselectUrll,
                        saveUrl: this.saveUrll,
                    } })
