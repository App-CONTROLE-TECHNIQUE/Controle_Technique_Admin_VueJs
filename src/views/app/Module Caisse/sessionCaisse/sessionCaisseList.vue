...
<script>
    ...
    import listHeader from './sessionCaisseHeaders';
    import constants from "../../../../plugins/constants";
    export default {
        name: "venteList",
        data(){
            return{
                pagename:'Session de caisse',
                show:true,
                title:'Session de caisses',
                saveUrll: constants.resource_url+'admin/sessioncaisses',
                list: constants.resource_url+'admin/sessioncaisses',
                name_graph: 'Session Caisse',
                dialogDelete:false,
                previousButton:true,
                editButton:false,
                addButton: false,
