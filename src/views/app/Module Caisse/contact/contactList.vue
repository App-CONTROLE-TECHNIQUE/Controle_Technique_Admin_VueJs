...
<script>
    ...
    import listHeader from './contactHeaders';
    import addjson from './contactField'
    import constants from "../../../../plugins/constants";
    import model from './contactModel.json'
    export default {
        name: "clientList",
        data() {
            return{
        ...
        methods: {
            ...
            deleteItemConfirm (item){
                axios.delete(this.list+'/'+item.contactId)
                    .then(org => {
