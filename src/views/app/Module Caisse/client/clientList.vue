...
<script>
    ...
    import listHeader from './clientHeaders';
    import addjson from './clientField'
    import constants from "../../../../plugins/constants";
    import model from './clientModel.json'
    export default {
        name: "clientList",
        data() {
            return{
                ...
                show:true,
                title:'Client',
                saveUrll: constants.resource_url+'admin/clients',
                fillselectUrll: constants.resource_url+'admin/organisation/child/select',
                deleteUrl: constants.resource_url+'clients',
                name_graph: 'Client',
                modell: model,
                dialogDelete:false,
                previousButton:true,
                ...
                deleteButton:true,
                headers:listHeader,
                list: constants.resource_url+'admin/clients',
                list_kanban:[],
                percent_visit:[],
                list_hist:[],
                abcis:[],
        ...
        methods: {
            ...
            deleteItemConfirm (item){
                axios.delete(this.list+'/'+item.clientId)
                    .then(org => {
