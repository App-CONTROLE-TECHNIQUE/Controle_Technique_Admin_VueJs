<template>
    <GlobalVue v-if="show" :home="home" :dialogDelete="dialogDelete" :pagename="pagename" :previousButton="previousButton" :list="list" :headers="headers" :editButton="editButton"
               ...
               :addjson="addjson" :deleteUrl="deleteUrl" :fillselectUrl="fillselectUrll"
...
<script>
    ...
    import listHeader from './caisseListHeader';
    import addjson from './caisseFields'
    ...
    export default {
        data() {
            ...
            return{
                ...
                show:true,
                title:'Caisse',
                deleteUrl: constants.resource_url+'admin/caisses',
        ...
        methods: {
            ...
            initialize () {
                ...
                this.list = constants.resource_url + 'admin/caisses';
                this.show = false
                this.$nextTick(() => {
                    this.show = true
            ...
            editItem (item) {
                ...
                this.$router.push({name: 'editcaisse', params:{ modelEdit:item } })
            ...
            {
                axios.delete(this.list+'/'+item.caisse_id)
                    .then(org => {
