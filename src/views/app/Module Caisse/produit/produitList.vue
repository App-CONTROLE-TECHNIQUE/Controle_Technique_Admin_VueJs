...
<script>
    ...
    import listHeader from './produitHeaders';
    import addjson from './produitField'
    import constants from "../../../../plugins/constants";
    import model from './produitModel.json'
    export default {
        name: "userList",
        data() {
            return{
                ...
                show:true,
                title:'Produit',
                saveUrll: constants.resource_url+'admin/produits',
                fillselectUrll: constants.resource_url+'admin/organisation/child/select',
                fillSecondSelectUrll: constants.resource_url+'categorieproduits/select',
                fillThirdSelectUrll: constants.resource_url+'users/system/select',
                deleteUrl: constants.resource_url+'admin/produits',
                name_graph: 'Caissier',
                modell: model,
                dialogDelete:false,
                previousButton:true,
                ...
                deleteButton:true,
                headers:listHeader,
                list: constants.resource_url+'admin/produits',
                list_kanban:[],
                percent_visit:[],
                list_hist:[],
                abcis:[],
        ...
        methods: {
            ...
            initialize () {
                ...
                this.list = constants.resource_url + 'admin/produits';
            ...
            deleteItemConfirm (item){
                axios.delete(this.list+'/'+item.produitId)
                    .then(org => {
