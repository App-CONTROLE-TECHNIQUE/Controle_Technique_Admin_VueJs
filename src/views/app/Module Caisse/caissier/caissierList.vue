...
<script>
    ...
    import listHeader from './caissierHeaders';
    import addjson from './caissierField'
    import constants from "../../../../plugins/constants";
    import model from './caissierModel.json'
    export default {
        name: "CaissierList",
        data() {
            return{
                ...
                show:true,
                title:'Caissier',
                saveUrll: constants.resource_url+'admin/caissiers',
                ...
                deleteButton:true,
                headers:listHeader,
                list: constants.resource_url+'admin/caissiers',
                list_kanban:[],
                percent_visit:[],
                list_hist:[],
                abcis:[],
        ...
        methods: {
            ...
            deleteItemConfirm (item){
                axios.delete(this.list+'/'+item.caissierId)
                    .then(org => {
